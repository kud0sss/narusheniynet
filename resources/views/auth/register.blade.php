<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="middlename" class="block mt-1 w-full" type="text" name="middlename" :value="old('middlename')" required autocomplete="additional-name" />
        ...
        <div class="mt-4">
            ...
            <x-tel-input id="tel" class="block mt-1 w-full" name="tel" :value="old('tel')" required autofocus autocomplete="tel" />
